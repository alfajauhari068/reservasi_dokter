...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1>Edit Schedule</h1>
        <p class="text-muted">Perbarui jadwal praktek.</p>
    </div>
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('dokter.schedule.update', $schedule) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary">Perbarui Schedule</button>
                    </div>
                </form>
            </div>
        </div>
