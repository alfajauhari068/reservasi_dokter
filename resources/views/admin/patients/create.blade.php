...
@section('page-subtitle', 'Admin mendaftarkan pasien (termasuk tanpa akun)')
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0 py-4">
        <div class="d-flex align-items-start justify-content-between gap-3">
            <div>
                <h4 class="mb-2 fw-bold">Tambah Pasien</h4>
                <p class="text-muted mb-0">Isi data identitas pasien untuk kebutuhan appointment.</p>
            </div>
            <div>
    ...
    <div class="card-body p-4">
        ...
        <form method="POST" action="{{ route('admin.patients.store') }}" class="row g-3">
            @csrf
