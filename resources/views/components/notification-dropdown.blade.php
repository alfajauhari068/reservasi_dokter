...
<div class="dropdown admin-notification-dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-end shadow-lg admin-notification-dropdown fixed-mobile" aria-labelledby="notificationDropdown" style="max-height: 350px; overflow-y: auto;">
